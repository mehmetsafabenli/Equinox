...
namespace Eqn.ExceptionHandling.AspNetCore.ExceptionHandling;
...
public interface IExceptionToErrorInfoConverter
{
    ...
    /// <returns>Error info or null</returns>
    RemoteServiceErrorInfo Convert(Exception exception, Action<EqnExceptionHandlingOptions> options = null);
}
