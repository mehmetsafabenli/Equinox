...
public class MinioBlobProvider : BlobProviderBase, ITransientDependency
{
    ...
    public override async Task<Stream> GetOrNullAsync(BlobProviderGetArgs args)
    {
        ...
        await client.GetObjectAsync(new GetObjectArgs().WithBucket(containerName).WithObject(blobName)
    ...
    public override async Task<string> GetUriAsync(BlobProviderGetArgs args)
    {
        var blobName = MinioBlobNameCalculator.Calculate(args);
        var client = GetMinioClient(args);
        var containerName = GetContainerName(args);
