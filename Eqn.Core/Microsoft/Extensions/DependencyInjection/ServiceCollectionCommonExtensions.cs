...
namespace Eqn.Core.Microsoft.Extensions.DependencyInjection;
...
public static class ServiceCollectionCommonExtensions
{
    ...
    public static IServiceProvider BuildServiceProviderFromFactory<TContainerBuilder>([NotNull] this IServiceCollection services, Action<TContainerBuilder> builderAction = null)
    {
        ...
        {
            throw new EqnException($"Could not find {typeof(IServiceProviderFactory<TContainerBuilder>).FullName} in {services}.");
        }
    ...
    {
        return services
            .GetSingletonInstance<IEqnApplication>()
            .ServiceProvider
            .GetService<T>();
    }
