...
public abstract class EqnModule :
    IEqnModule,
    ...
    IPostConfigureServices
{
    ...
    protected internal ServiceConfigurationContext ServiceConfigurationContext {
        get {
            ...
            {
                throw new EqnException($"{nameof(ServiceConfigurationContext)} is only available in the {nameof(ConfigureServices)}, {nameof(PreConfigureServices)} and {nameof(PostConfigureServices)} methods.");
            }
    ...
    public static bool IsEqnModule(Type type)
    {
        ...
        return
            ...
            typeof(IEqnModule).GetTypeInfo().IsAssignableFrom(type);
    }

    internal static void CheckEqnModuleType(Type moduleType)
    {
        if (!IsEqnModule(moduleType))
        {
            throw new ArgumentException("Given type is not an Eqn module: " + moduleType.AssemblyQualifiedName);
        }
    }
