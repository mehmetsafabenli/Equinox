...
using Eqn.AspNetCore.Eqn.AspNetCore;
using Eqn.Core;
...
{
    protected EqnConventionalControllerOptions Options { get; }

    public ConventionalRouteBuilder(IOptions<EqnConventionalControllerOptions> options)
    {
    ...
    protected virtual string GetApiRoutePrefix(ActionModel actionModel, ConventionalControllerSetting configuration)
    {
        ...
        {
            return EqnAspNetCoreConsts.DefaultIntegrationServiceApiPrefix;
        }

        return EqnAspNetCoreConsts.DefaultApiPrefix;
    }
