...
public class EqnAutoValidateAntiforgeryTokenAttribute : Attribute, IFilterFactory, IOrderedFilter
{
    /// <summary>
    ...
    {
        return serviceProvider.GetRequiredService<EqnAutoValidateAntiforgeryTokenAuthorizationFilter>();
    }
}
